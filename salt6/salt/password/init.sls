...
set-modify-password:
  file.replace:
    ...
    - pattern: "^password.*requisite.*pam_cracklib.so.*"
    - repl: "password    requisite     pam_cracklib.so try_first_pass retry=3 minlen=8 dcredit=-1 ucredit=-1 ocredit=-1 lcredit=-1"
